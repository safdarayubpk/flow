      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center text-gray-500 px-2">
            <h3 className="text-lg font-medium text-gray-700 mb-2">Hi! I'm your Todo Assistant</h3>
            <p className="text-sm">Try saying:</p>
            <ul className="mt-2 text-left text-xs space-y-1 text-gray-600">
              <li className="bg-gray-100 rounded px-2 py-1">"Add a task to buy groceries"</li>
              <li className="bg-gray-100 rounded px-2 py-1">"Show my tasks"</li>
              <li className="bg-gray-100 rounded px-2 py-1">"Complete task 3"</li>
            </ul>
          </div>
        ) : (
      ...
      <form onSubmit={handleSubmit} className="border-t p-3">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="bg-indigo-600 text-white rounded-md px-3 py-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
